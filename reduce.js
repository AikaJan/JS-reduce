...
function vowelCount(str) {
    ...
    return lowercaseStr.split('').reduce((result, char) => {
...
function partition(arr, callback) {
  ...
  const result1 = partition(arr, isEven);
  console.log(result1); // Output: [[2, 4, 6, 8], [1, 3, 5, 7]]
  ...
  const names = ['Elie', 'Colt', 'Tim', 'Matt'];
  const result2 = partition(names, isLongerThanThreeCharacters);
  console.log(result2); // Output: [['Elie', 'Colt', 'Matt'], ['Tim']]
